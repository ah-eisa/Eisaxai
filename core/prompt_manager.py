...
{{"route": "STOCK_ANALYSIS|FINANCIAL|PORTFOLIO|GENERAL|CLARIFY", "handler": "HANDLER_NAME", "instruction": "clear English instruction", "clarification_question": "only if CLARIFY"}}
