...
*Mode: 1pager · Distribution: Investment Committee · Page break may be recommended below.*
...
| Field | Detail |
| --- | --- |
| Key Decision | Current allocation may remain within mandate if tracking error and factor exposures remain within approved thresholds. |
...
**Key Risks**
1. Benchmark note may require attribution context: insufficient regime history.
2. Benchmark note may require attribution context: fewer than 12 months of overlapping history.
3. liquidity crisis may model P10 at -53.0% and median drawdown at -43.3%.
...
**Exhibits**
- Exhibit 1: Benchmark-relative diagnostics - payload reference: benchmark_relative
- Exhibit 2: Forward scenario distribution - payload reference: forward_scenario
...
| committee_brief hash | eec62a9edd8323c0 |
