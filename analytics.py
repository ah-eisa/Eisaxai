            ...
            try:
                ...
                for _mkt in _cache_markets:
                    ...
                    if not _match.empty:
                        ...
                        logger.info("[DataLayer] Found %s in %s snapshot: price=%.2f", target, _mkt, float(_cache_row.get("close",0) or 0))
                        break
...
"""
                ...
                if _low_data_compact_mode:
                    # V4-flash reasoning model needs headroom (was 1600 — killed output).
