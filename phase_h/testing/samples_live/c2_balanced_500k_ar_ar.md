...
**التاريخ:** May 18, 2026  |  **رأس المال:** $500,000  |  **المدة:** 7 سنوات  |  **الأسواق:** Global
...
|--------|--------|---------|
| العائد المتوقع (سنوي) | **~14.2%** | [STRONG] |
| التقلب المتوقع | **~12.7%** | [MODERATE] |
| Sharpe Ratio | **~0.76** | [ACCEPTABLE] |
| Beta (vs MSCI World) | **~0.66** | [LOW] |
| القيمة المتوقعة بعد 7 سنوات | **$1,265,028** | ربح متوقع **$765,028** |
...
|--------|--------|-------------|---------------|
| **US** | 33.5% | $167,500 | US Large Cap Tech, B (B) |
| **GCC** | 30.0% | $150,000 | 2222 (2222), 4190 (4190), FERTIGLB (FERTIGLB), ORDS (ORDS) |
| **Cash** | 10.0% | $50,000 | Cash / T-Bills |
| **Egypt** | 8.5% | $42,500 | EGAL (EGAL) |
| **Diversification** | 7.0% | $35,000 | US Healthcare |
| **Crypto** | 5.2% | $26,000 | Bitcoin |
| **Bonds** | 5.0% | $25,000 | US Treasuries (LT), EM Bonds |
| **Commodities** | 0.8% | $4,000 | Copper |

### Optimal Asset Weights

| Asset Class | Region | Weight | ~$ on $100k | Proxy | Role | Construction Rationale |
|-------------|--------|--------|-------------|-------|------|------------------------|
| **US Large Cap Tech** | US | 25.0% | $125,000 | `QQQ` | Strategic Core | Long-duration growth sleeve · captures secular AI/tech earnings |
| **Bitcoin** | Crypto | 5.2% | $25,905 | `BTC-USD` | Opportunistic Satellite | Asymmetric satellite · high-volatility return contributor (not a hedge) |
| **US Treasuries (LT)** | Bonds | 1.6% | $7,829 | `TLT` | Income / Diversification | Long-duration UST · negative correlation to equity in deflationary shocks |
| **EM Bonds** | Bonds | 3.4% | $17,171 | `EMB` | Income / Diversification | EM credit · spread carry with FX/default risk overlay |
| **Cash / T-Bills** | Cash | 10.0% | $50,000 | `BIL` | Income / Diversification | Dry powder · liquidity buffer and risk-free yield anchor |
| **US Healthcare** | Diversification | 7.0% | $35,000 | `XLV` | Income / Diversification | Short-duration anchor · capital preservation with low rate risk |
| **Copper** | Commodities | 0.8% | $4,095 | `CPER` | Real-Asset / Inflation Sleeve | Real-asset exposure · inflation pass-through and macro cyclicality |
| **2222 (2222)** | GCC | 8.5% | $42,500 | `2222` | Tactical Allocation | Regional exposure · GCC growth premium, low correlation to US equities |
| **4190 (4190)** | GCC | 8.5% | $42,500 | `4190` | Tactical Allocation | Regional exposure · GCC growth premium, low correlation to US equities |
| **FERTIGLB (FERTIGLB)** | GCC | 4.5% | $22,500 | `FERTIGLB` | Satellite / Diversifier | Regional exposure · GCC growth premium, low correlation to US equities |
| **ORDS (ORDS)** | GCC | 8.5% | $42,500 | `ORDS` | Tactical Allocation | Regional exposure · GCC growth premium, low correlation to US equities |
| **EGAL (EGAL)** | Egypt | 8.5% | $42,500 | `EGAL` | Tactical Allocation | Frontier-market tilt · structural reform exposure (higher idiosyncratic risk) |
| **B (B)** | US | 8.5% | $42,500 | `B` | Tactical Allocation | Energy cyclicality · inflation hedge and macro pro-cyclical exposure |
...
2. وزّع $500,000 حسب نسب الأصول في القسم D
3. أعد التوازن كل 6-12 شهر
4. تجنّب التصفية في تراجعات السوق قصيرة المدى — أفق 7 سنوات يستوعب دورات السوق
...
| الحقل | القيمة |
|-------|--------|
| معرّف اللقطة (Snapshot ID) | `be83ae8ae054` |
...
| المقياس | القيمة | التصنيف |
| --- | --- | --- |
| العائد النسبي | -0.90% | (متوسط) |
| خطأ التتبع | 0.55% | (منخفض) |
| نسبة المعلومات | -1.65 | (منخفض) |
| ألفا المتجدد (12 شهر) | +0.03% | — |
| بيتا المتجدد (12 شهر) | 0.20 | — |
| الانخفاض النسبي | -0.26% | (منخفض) |
| احتواء الصعود | 0.21 | (منخفض) |
| احتواء الهبوط | 0.07 | (منخفض) |
| التذبذب النسبي | 0.20 | — |
| الحصة النشطة | 21.00% | (منخفض) |
...
| execution_diag hash | d4bd7076aa6db1a6 |
| factor_decomp hash | 191041657f8f20cd |
| forward_scenario hash | 2f6da720cfc43c95 |
